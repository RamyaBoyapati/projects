...
<jsp:useBean id="beanDao" class="com.infinite.inventorymanagement.PaymentDAO"/>
<jsp:useBean id="orderDao" class="com.infinite.inventorymanagement.OrderDAO"/>
	<jsp:useBean id="stockDao" class="com.infinite.inventorymanagement.StockDAO"/>
   ...
   <input type="text" class="form-control" name="amt" value="${param.total}"/>
    ...
    <input type= "submit" class="btn btn-primary" value ="ADD">
 	...
 	<c:if test="${param.amt != null}">
		<jsp:useBean id="wallet" class="com.infinite.inventorymanagement.Wallet" />
		<jsp:useBean id="dao" class="com.infinite.inventorymanagement.WalletDAO"/>
