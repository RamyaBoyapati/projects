<%@page import="com.infinite.inventorymanagement.CustomerDAO"%>
...
<input type="submit"  value="SUBMIT"><br/><br/>
			...
			<jsp:useBean id="beanDAO" class="com.infinite.inventorymanagement.CustomerDAO"/>
	...
	<c:if test="${c == 0 && param.customerName != null}">
	<jsp:useBean id="customer" class="com.infinite.inventorymanagement.Customer"/>
