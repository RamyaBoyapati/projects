...
<jsp:useBean id="beanDao" class="com.infinite.InventoryManagementProject.PaymentDAO"/>
<jsp:useBean id="orderDao" class="com.infinite.InventoryManagementProject.OrderDAO"/>
	<jsp:useBean id="stockDao" class="com.infinite.InventoryManagementProject.StockDAO"/>
   ...
   <input type="text" class="form-control" name="amt" value="${param.total}"/>
    ...
    <input type= "submit" class="btn btn-primary" value ="ADD">
 	...
 	<c:if test="${param.amt != null}">
		<jsp:useBean id="wallet" class="com.infinite.InventoryManagementProject.Wallet" />
		<jsp:useBean id="dao" class="com.infinite.InventoryManagementProject.WalletDAO"/>
