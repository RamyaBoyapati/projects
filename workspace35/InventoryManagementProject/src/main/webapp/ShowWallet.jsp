...
<center>
	...
	<jsp:useBean id="beanWallet" class="com.infinite.InventoryManagementProject.Wallet"></jsp:useBean>	
	<jsp:setProperty property="*" name="beanWallet"/>
	<jsp:useBean id="beanDao" class="com.infinite.InventoryManagementProject.WalletDAO"></jsp:useBean>
	<form>
