...
<jsp:useBean id="dao" class="com.infinite.InventoryManagementProject.CustomerDAO"></jsp:useBean>
	...
	<c:if test="${param.customerName != null }">
		<jsp:useBean id="customer" class="com.infinite.InventoryManagementProject.Customer"/>
