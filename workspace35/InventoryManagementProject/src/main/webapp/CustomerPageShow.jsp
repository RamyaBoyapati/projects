...
<center>
	...
	<jsp:useBean id="beanStock" class="com.infinite.InventoryManagementProject.Customer"></jsp:useBean>	
	<jsp:setProperty property="*" name="beanStock"/>
	<jsp:useBean id="beanDao" class="com.infinite.InventoryManagementProject.CustomerDAO"></jsp:useBean>
