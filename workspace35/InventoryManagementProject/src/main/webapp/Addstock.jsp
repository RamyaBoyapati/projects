...
<body > 
<jsp:useBean id="beanDao" class="com.infinite.InventoryManagementProject.StockDAO"/>
...
<center>
 ...
 <c:set var="q" value="${beanDao.searchitem(param.itemname)}"/>
    ...
    <c:if test="${q == null }">
   	<jsp:useBean id="beanStock" class="com.infinite.InventoryManagementProject.StockDetails" />
